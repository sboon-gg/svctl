...
type PRBF2 struct {
	...
	Admins           []interface{}   `yaml:"admins"`
	LiteAdmins       []interface{}   `yaml:"liteAdmins"`
	PrismUsers       []interface{}   `yaml:"prismUsers"`
	ReservedSlotsNum int             `yaml:"reservedSlotsNum"`
	ReservedSlots    []interface{}   `yaml:"reservedSlots"`
	Maplist          []interface{}   `yaml:"maplist"`
	AllMaps          []interface{}   `yaml:"allMaps"`
	CommandAliases   interface{}     `yaml:"commandAliases"`
	Reasons          interface{}     `yaml:"reasons"`
